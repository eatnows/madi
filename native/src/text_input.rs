//! Single-line text input with IME support (Korean composition etc.), adapted from gpui's
//! `input` example (Apache-2.0). Reused for search fields now and the editor's basis later.
use std::ops::Range;
